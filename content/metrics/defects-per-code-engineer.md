...
background:#f8fafc;text-align:center;color:#5a6d82;font-style:italic">
  [IMAGE: A flowchart showing the defect attribution pipeline — from defect discovery through git blame analysis, to full-weight attribution across multiple engineers, to the Tribunal scorecard and the PeopleWare HRaaS escalation fork based on consecutive-convoy threshold breaches]
</div>
