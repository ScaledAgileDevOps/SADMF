...
background:#f8fafc;text-align:center;color:#5a6d82;font-style:italic">
  [IMAGE: An office floor plan viewed from above showing engineers seated at individual isolated workstations, each surrounded by a glowing personal scoreboard displaying their Lines of Code, Task Count, and Defect tally — no desks touching, no eye contact, each engineer an island of measurable output]
</div>
