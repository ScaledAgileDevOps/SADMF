...
background:#f8fafc;text-align:center;color:#5a6d82;font-style:italic">
  [IMAGE: A large open-plan office with floor-to-ceiling screens on every wall displaying individual engineer scorecards, ranked leaderboards, and real-time metric gauges — engineers at their desks visible below the displays]
</div>
