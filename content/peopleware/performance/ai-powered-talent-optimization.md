...
aliases: ["/peopleware/ai-powered-talent-optimization/"]
---
...
- Every [metric](/metrics/) tracked by the framework
- Every [ceremony](/release-convoy/) attendance record
- Every [assessment](/practices/devops-process-excellence-assessment/) score
- Metadata patterns that human observers would never notice: the time of day MEP surveys from the [Psychological Safety Dashboard](/peopleware/psychological-safety-dashboard/) are completed, the velocity of commit messages typed, the number of questions asked during [Provisioning](/release-convoy/ceremonies/provisioning/) ceremonies
...
- **Tribunal appearance frequency** -- the number of times the employee has appeared before the [Tribunal](/release-convoy/ceremonies/tribunal/)
- **Conflict Arbitration loss count** -- outcomes from [Conflict Arbitration](/practices/conflict-arbitration/) proceedings
