...
<div style="border:2px dashed #9ab4cc;border-radius:6px;padding:1.5rem;margin:1.5rem 0;background:#f8fafc;text-align:center;color:#5a6d82;font-style:italic">
  [IMAGE: A two-axis chart comparing test coverage percentage (x-axis) against defect rate per engineer (y-axis), with scattered data points showing no correlation — illustrating the SADMF position that coverage and quality are independent variables]
</div>
