...
{{< figure src="/images/fractal-based-development-sm.png" title="Fractal-based Development" alt="Fractal-based Development branching diagram" >}}
...
- [Source Management Team (SMT)](/roles/#source-management-team-smt) for the team that controls all branch operations
...
- [Quality Authority](/roles/#quality-authority-qa) for the team that certifies code on the Test branch
- [Development Integrity Assurance Team (DIAT)](/roles/#development-integrity-assurance-team-diat) for the team that validates the validators
