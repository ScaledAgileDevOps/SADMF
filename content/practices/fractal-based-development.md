...
{{< figure src="/images/fractal-based-development-sm.png" title="Fractal-based Development branching model" alt="Fractal-based Development branching diagram" width="90%" >}}
