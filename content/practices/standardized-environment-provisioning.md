...
<div style="border:2px dashed #9ab4cc;border-radius:6px;padding:1.5rem;margin:1.5rem 0;background:#f8fafc;text-align:center;color:#5a6d82;font-style:italic">
  [IMAGE: The SEPAW Reference Binder open to a sample checklist page, showing numbered rows with action descriptions, verification substeps, and a column of Build Engineer initials; a reference screenshot is visible inset beside one step]
</div>
