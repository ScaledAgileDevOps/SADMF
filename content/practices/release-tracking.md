...
<div style="border:2px dashed #9ab4cc;border-radius:6px;padding:1.5rem;margin:1.5rem 0;background:#f8fafc;text-align:center;color:#5a6d82;font-style:italic">
  [IMAGE: Illustration of a sprawling Excel workbook with 47 visible tab labels along the bottom, color-coded by section, with the Commodore hunched over a laptop surrounded by printed sign-off sheets, coffee cups, and a handwritten correction scrawled in red marker across one cell]
</div>
