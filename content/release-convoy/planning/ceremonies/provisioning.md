...
aliases: ["/release-convoy/ceremonies/provisioning/"]
---
...
Each task in the spreadsheet must follow the approved naming convention: the convoy number prefix, followed by the feature identifier, followed by a sequential task number (e.g., `C17-F042-T003`). Tasks that do not follow this convention are rejected during [Code Inspection](/release-convoy/execution/ceremonies/code-inspection/) regardless of their implementation quality.
