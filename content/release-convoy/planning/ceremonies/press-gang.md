...
aliases: ["/release-convoy/ceremonies/press-gang/"]
---
...
- [Feature Captain](/roles/feature-captain/) for the role that selects engineers during the draft
- [Code Engineers](/roles/code-engineer/) for the resources being allocated
- [Provisioning](/release-convoy/planning/ceremonies/provisioning/) for how staffing needs are determined
- [Coding](/release-convoy/execution/ceremonies/coding/) for what happens after engineers are assigned
