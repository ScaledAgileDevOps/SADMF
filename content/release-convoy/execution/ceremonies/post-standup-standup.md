...
aliases: ["/release-convoy/ceremonies/post-standup-standup/"]
---
...
<div style="margin:2.5rem 0 1.5rem 0">
  ...
  <div style="display:flex;gap:1rem;margin-bottom:0;align-items:flex-start">
    ...
    <div style="flex:1;background:#e8edf5;border:1px solid #9ab4cc;border-radius:6px;padding:1rem 1.15rem">
      ...
      <div style="font-size:0.9rem;color:#1e3a5f;opacity:0.85">Commodore confirms all non-work has received adequate visibility. Participants are dismissed to attend the <a href="/release-convoy/execution/ceremonies/post-standup-standup-review/">Post-Standup Standup Review</a>.</div>
    </div>
  </div>
</div>
...
- [Post-Standup Standup Review](/release-convoy/execution/ceremonies/post-standup-standup-review/) for the documentation process that follows this ceremony
- [Scrum of Scrum of Scrums](/release-convoy/execution/ceremonies/scrum-of-scrum-of-scrums/) for the companion meeting covering active-work communication at scale
