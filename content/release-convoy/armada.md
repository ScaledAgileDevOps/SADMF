...
- More than 3 [Feature Teams](/roles/#feature-team-ft) exist across the organization
...
- The organization has hired enough [Feature Captains](/roles/#feature-captain-fc) to warrant a captain's captain

## Armada Command Structure

The Armada is commanded by an **Admiral**, who outranks all [Commodores](/roles/#commodore-c) and reports directly to the [Admirals Transformation Office](/roles/#admirals-transformation-office-ato). The Admiral's responsibilities include:
...
- Mediating priority disputes between [Commodores](/roles/#commodore-c) using [WSVF](/release-convoy/wsvf/) scores
...
- Cross-convoy dependency declarations, signed by all affected [Commodores](/roles/#commodore-c)
- An Armada-level risk register maintained by the [DIAT](/roles/#development-integrity-assurance-team-diat)
...
This 10-day event brings together all [Commodores](/roles/#commodore-c), [Feature Captains](/roles/#feature-captain-fc), and selected [Code Engineers](/roles/#code-engineer-ce) from every convoy. The first five days mirror the standard [Convoy Alignment](/release-convoy/agenda/) format. The second five days are dedicated to cross-convoy dependency negotiation, where teams discover that the dependencies identified during the first five days have already changed.
...
- **Admiral's Standup**: A daily 90-minute standing meeting where each [Commodore](/roles/#commodore-c) briefs the Admiral on convoy progress. Standing is mandatory to encourage brevity, though brevity has never been achieved.
...
- [Roles](/roles/#admirals-transformation-office-ato) for the Admirals Transformation Office that oversees Armadas
